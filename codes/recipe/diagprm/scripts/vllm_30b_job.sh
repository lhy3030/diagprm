...
#SBATCH --job-name=vllm_30b
#SBATCH --output=/data/home/scwb729/run/diagprm/job_logs/vllm_30b_%j.out
#SBATCH --qos=gpugpu

set -euo pipefail

echo "============================================================"
echo "  vLLM — Qwen3-30B-A3B-Instruct-2507"
...
PORT=8200
MODEL_PATH=/data/home/scwb729/run/model/Qwen3-30B-A3B-Instruct-2507
