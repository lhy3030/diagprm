...
from recipe.atpo.algo.med_algos import compute_grpo_outcome_advantage
from recipe.atpo.mt_metric_utils import (
...
class RayPPOTrainer:
    ...
    def init_workers(self):
        ...
        if self.config.actor_rollout_ref.rollout.mode == "async":
            from recipe.atpo.agent_loop import AgentLoopManager
