...
from recipe.atpo_atomic_fact.mt_reward_fn import parse_turns_from_response_mask, calculate_single_turn_reward
        ...
        while i < len(response_mask_list):
            if response_mask_list[i] == 0:
                ...
                if end_pos != len(response_mask_list): 
                    ...
                    # The AtomicFact prompt carries turn state on the user
                    # message; it is control text, not patient evidence.
                    human_text = re.sub(
